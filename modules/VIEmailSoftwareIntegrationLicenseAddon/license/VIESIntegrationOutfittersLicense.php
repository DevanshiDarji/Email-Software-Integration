 ...
 * 
 ********************************************************************************/
if(!class_exists('VIESIntegrationOutfittersLicense')) {
    class VIESIntegrationOutfittersLicense {
        ...
        public static function isValid($thisModule=null,$user_id=null,$force_validation=false) {
            ...
            $validated = VIESIntegrationOutfittersLicense::doValidate($thisModule);
        ...
        public static function validate() {
            ...
            $validated = VIESIntegrationOutfittersLicense::doValidate($currentModule,$_REQUEST['key']);
        ...
        public static function doValidate($thisModule,$key=null) {
            ...
            {
                $GLOBALS['log']->fatal('VIESIntegrationOutfittersLicense::doValidate() failed: '.print_r($response,true));
            }
            return $response;
        ...
        public static function change() {
            ...
            {
                header('HTTP/1.1 400 Bad Request');
                $GLOBALS['log']->fatal('VIESIntegrationOutfittersLicense::change() failed: '.print_r($response,true));
            } 
            else 
            {
                require_once('modules/Administration/Administration.php');
        ...
        public static function add() {
            ...
            $response = VIESIntegrationOutfittersLicense::doValidate($currentModule);
    ...
    class SugarOutfitters_API {
        private static function get_default_payload($module,$custom_data = array()) {
            ...
            if (empty($custom_data['key'])){
                $key = VIESIntegrationOutfittersLicense::getKey($module);
