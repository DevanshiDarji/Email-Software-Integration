...
if($_REQUEST['method'] == 'validate') {
    VIESIntegrationOutfittersLicense::validate();
} else if($_REQUEST['method'] == 'change') {
    VIESIntegrationOutfittersLicense::change();
} else if($_REQUEST['method'] == 'add') {
    VIESIntegrationOutfittersLicense::add();
    ...
    $validate_license = VIESIntegrationOutfittersLicense::isValid($currentModule,$user_id,true);
